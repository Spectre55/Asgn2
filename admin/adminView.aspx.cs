...
public partial class admin_adminView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DropDownList EditDropDownList = (DropDownList)ListView1.FindControl("EditDropDownList");
            DropDownList EditDropDownList1 = (DropDownList)ListView1.FindControl("EditDropDownList1");
        if (groupEditDropDownList != null)
           ...
           if (groupInsertDropDownList != null)
            ...
            if (EditDropDownList != null)
            {
                ...
                EditDropDownList.Items.Insert(0, new ListItem("NULL", ""));
            }
            if (EditDropDownList1 != null)
            {
                EditDropDownList1.DataBind();
                EditDropDownList1.Items.Insert(0, new ListItem("NULL", ""));
            }
